...
namespace CodeTestRebtel.Data.Tests
{
    class when_retrieving_all_books
    {
        ...
        private Establish context = () =>
            {
                ...
                A.CallTo(() => _store.GetAllBooks()).Returns(booksList);
        ...
        private It the_id_of_the_first_element_in_the_book_list_should_equal_bookId1 = () => _books.ElementAt(0).Id.ShouldEqual(_bookId1);
        private It the_id_of_the_second_element_in_the_book_list_should_equal_bookId2 = () => _books.ElementAt(1).Id.ShouldEqual(_bookId2);
    }
}
