...
namespace CodeTestRebtel.Data.Tests.RepositoryTest
{
    class when_loaning_a_book_that_doesnt_exist
    {
        ...
        private Establish context = () =>
        {
            ...
            _booksList = new List<Book> { new Book { Id = Guid.NewGuid(), Author = "Author", ISBN = "ISBN", Title = "Title" } };
        ...
        private It should_be_false_the_book_doesnt_exist = () => _loanBool.ShouldEqual(false);
