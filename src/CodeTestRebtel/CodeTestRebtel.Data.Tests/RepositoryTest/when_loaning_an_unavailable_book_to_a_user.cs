...
namespace CodeTestRebtel.Data.Tests.RepositoryTest
{
    class when_loaning_an_unavailable_book_to_a_user
    {
        ...
        private Establish context = () =>
        {
            ...
            _booksList = new List<Book> { new Book { Id = _bookId, Author = "Author", ISBN = "ISBN", Title = "Title", LoanedTo = Guid.NewGuid() } };
        ...
        private It should_be_false_book_is_already_borrowed_out = () => _loanBool.ShouldEqual(false);
