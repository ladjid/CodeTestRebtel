...
{
    class when_returning_a_book_that_doesnt_exist
    {
        ...
        private Establish context = () =>
        {
            ...
            _booksList = new List<Book> { new Book { Id = Guid.NewGuid(), Author = "Author", ISBN = "ISBN", Title = "Title", LoanedTo = null } };
        ...
        private It should_be_false_books_doesnt_exist = () => _returnedBool.ShouldEqual(false);
