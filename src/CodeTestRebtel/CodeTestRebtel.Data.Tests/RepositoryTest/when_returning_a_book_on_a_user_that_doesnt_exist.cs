...
namespace CodeTestRebtel.Data.Tests.RepositoryTest
{
    class when_returning_a_book_on_a_user_that_doesnt_exist
    {
        ...
        private Establish context = () =>
        {
            ...
            _userList = new List<User> { new User { Id = Guid.NewGuid(), Firstname = "Firstname", Lastname = "Lastname", BooksBorrowed = new List<Guid>() } };
        ...
        private It should_be_false_user_doesnt_exist = () => _returnedBool.ShouldEqual(false);
